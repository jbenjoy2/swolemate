...
physioball = Equipment(name='physioball/swissball')
...
resistance = Equipment(name='resistance bands/tubes')
...
db.session.add_all([barbell, kettlebell, dumbbell, half, bench, pullup, body, physioball, medicine_ball, curl,
